...
class stereoCamera(object):
    def __init__(self):
        # 左相机内参
        self.cam_matrix_left = np.array([[686.647712296467, 0, 463057250717],
                                         [0, 678.901192105738, 364.783311120389],
                                         [0, 0, 1]])
        # 右相机内参
        self.cam_matrix_right = np.array([[688.943064015353, 0, 632.788346739486],
                                          [0, 679.655461802906, 359.228860090357],
                                          [0, 0, 1]])
        ...
        # 旋转矩阵
        self.R = np.array([[0.999947931,0.000265622,-0.010201249],
                          [-0.000151566,0.999937493,0.011179774],
                          [0.010203581,-0.011177645,0.999885467]])
        # 平移矩阵
        self.T = np.array([[-60.128225691988], [0.159847893833871], [-0.582098124933243]])
